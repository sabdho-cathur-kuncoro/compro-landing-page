...
export default function WhatsAppFab() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-22 right-6 z-50 group"
    ...
    >
      <div className="relative">
        ...
        {/* Main button */}
        <div className="relative bg-linear-to-br from-green-400 to-green-600 rounded-full p-4 shadow-lg shadow-green-500/50 hover:shadow-green-500/70 transition-shadow">
